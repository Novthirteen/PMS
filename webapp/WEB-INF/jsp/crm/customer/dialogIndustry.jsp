...
%>
<form action="crm.dialogIndustryList.do" method="POST" name=frm>
<title>Industry Selection</title>
<input type="hidden" name="pageNumber" id = "pageNumber" value="<%=pageNumber%>">
<input type="hidden" name="FormAction" id = "FormAction">
<table width=100% align=center>
	<CAPTION align=center class=pgheadsmall>Industry Selection</CAPTION>
</table>
<table width=100% align=center Frame=box rules=none border=1 bordercolordark=black bordercolorlight=white bgcolor=white>
	<tr bgcolor="e9eee9">
		<td width="40%" class=lblbold>
			#&nbsp;					
		</td>
		<td width="60%" class=lblbold>Description</td>
	</tr>
		<bean:define id="offset" name="UserPageBean" property="offset" />
		<bean:define id="maxPage" name="UserPageBean"  property="maxPage" />		
		<logic:iterate id="ItemList"  name="UserPageBean" property="itemList" type="com.aof.component.crm.customer.Industry" indexId="index" length="<%=maxPage.toString()%>" offset="<%=offset.toString()%>">								
			<tr class="listbody">
				<td>
					<input type=radio name=chk value="<bean:write property="id" name="ItemList"/>|<bean:write property="description" name="ItemList"/>">
				</td>
	...
	<tr>
		...
		<logic:iterate id="PageNumberList"  name="PageNumberList" >
			...
			<logic:notEqual name="PageNumberList" property="pageLink" value="0">
				<html:link page="/crm.dialogIndustryList.do" paramId="pageNumber" paramName="PageNumberList" paramProperty="pageLink">
					<bean:write name="PageNumberList" property="pageNumber" />
				</html:link >
			</logic:notEqual>
			&nbsp
	...
	<tr>
      <td colspan=4>
		 ...
		 <tr>
         <tr>
          <td class=LblBold>Search for Industry Description</td>
