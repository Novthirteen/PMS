...
%>
<html:form action="/SalesUserList.do" method="POST" >
...
<table width=100% align=center>
	...
	<tr>
      <td colspan=4>
         ...
         <tr>
          <td class=LblBold>Only Sales</td>
          <td colspan=2>
            <input type=radio name='sales' value='1'<%if (SalesOpt.equals("1")) {%> checked<%}%>>&nbsp;Yes&nbsp;&nbsp;&nbsp;
            <input type=radio name=sales value='2' <%if (SalesOpt.equals("2")) {%> checked<%}%>>&nbsp;No
          </td>
		<td align='left'><input type=button class=button name='btn1' value='Go' onclick='javascript:fnSubmit1()'></td>
         </tr>
         <tr>
