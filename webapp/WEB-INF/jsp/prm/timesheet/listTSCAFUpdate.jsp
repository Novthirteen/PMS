...
<%
if (true|| AOFSECURITY.hasEntityPermission("TIME_SHEET", "_CAF", session)) {
...
<caption class="pgheadsmall">View Time Sheet Data for CAF Update</caption> 
<tr>
	<td>
	...
	<td>
		<table border="0" cellpadding="1" cellspacing="1" width=100%>
			<tr bgcolor="#e9eee9">
				...
				<td class="lblbold">&nbsp;Outstanding CAF Hours&nbsp;</td>
				<td class="lblbold">&nbsp;&nbsp;</td>
				<td class="lblbold">&nbsp;Week&nbsp;</td>
				<td class="lblbold">&nbsp;Period&nbsp;</td>
				<td class="lblbold">&nbsp;Total Hours&nbsp;</td>
			...
			for (int i=0 ; i <= HalfWeeksInYear ; i++) {%>
				...
				if (WithActual1) {
					if (findActual1.get(0).equals(Date_formater.format(DateDisplay))) {
						DisplayText = "<td align=CENTER>"+findActual1.get(1)+"</td>";
						out.println(DisplayText);
						DisplayText = "<td align=CENTER>"+findActual1.get(2)+"</td>";
						out.println(DisplayText);
						NullData = false;
						if (itActual1.hasNext()){
							findActual1 = (ArrayList)itActual1.next();
				...
				if (WithActual2) {
					if (findActual2.get(0).equals(Date_formater.format(DateDisplay))) {
						DisplayText = "<td align=CENTER>"+findActual2.get(1).toString()+"</td>";
						out.println(DisplayText);
						DisplayText = "<td align=CENTER>"+findActual2.get(2)+"</td>";
						out.println(DisplayText);
						NullData = false;
						if (itActual2.hasNext()){
							findActual2 = (ArrayList)itActual2.next();
...
<Form action="editTSCAFUpdate.do" name="frm" method="post">
