...
<tr align="center" bgcolor="#e9eee9">
	<TD align="center">
		<input type="checkbox" class="checkboxstyle" name="transactionId" value="<%=btd.getTransactionId()%>">
	</TD>
	<TD align="left">
...
<tr>
	<TD align="left" colspan="7">
		<input type="button" class="button" name="add" value="add to billing list">
	</TD>
</tr>