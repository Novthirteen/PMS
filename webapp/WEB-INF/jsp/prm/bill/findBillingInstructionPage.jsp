...
<%
Log log = LogFactory.getLog("findBillingInstructionList.jsp");
try{ 
...
<TABLE border=0 width='100%' cellspacing='2' cellpadding='2' class=''>
 	<TR bgcolor="#e9eee9">
	    ...
	    <td align="center" class="lblbold">Alownce Amount (RMB)</td>
	    <td align="center" class="lblbold">Expense Amount (RMB)</td>
 	...
 	<tr bgcolor="#e9eee9">  
        ...
        <td align="right">                 
           <%=formater.format(sqlResult.getDouble(row, "allowanceAmount"))%>
        </td>
         <td align="right">                 
           <%=formater.format(sqlResult.getDouble(row, "expenseAmount"))%>
        </td>
        <td align="right">                 
	...
	<%
 	...
 	%>
 	<tr bgcolor="#e9eee9">
    	<td align="center" class="lblerr" colspan="17">
    		No Record Found.
    	</td>
    </tr>
 	<%
