...
<%
try {
if (AOFSECURITY.hasEntityPermission("OUTSTANDING_TS_RPT", "_VIEW", session)) {
%>
...
<TABLE border=0 cellPadding=0 cellSpacing=0 width=100%>
	<caption class="pgheadsmall">Outstanding TS Approval Report</caption> 
	<tr>
		<td>
			<Form action="pas.report.OutstandingTSRpt.do" name="frm" method="post">
				...
				<table width=100% >
					...
					<tr>
						...
						<td class="lblLight">
							...
							<%
							if (AOFSECURITY.hasEntityPermission("OUTSTANDING_TS_RPT", "_ALL", session)) {
					...
					<tr>
					    ...
					    <td class="lblLight">
					    	<input type="text" class="inputBox" name="pm" size="12" value="">
					    </td>
...
<table width="100%" cellpadding="1" border="0" cellspacing="1">
	<tr>
		<td>
			<display:table name="requestScope.QryList.rows" export="true" class="ITS" requestURI="pas.report.OutstandingTSRpt.do" pagesize="15">
				<display:column property="proj_id" title="Project ID"/>
				<display:column property="proj_name" title="Project Name"/>
				<display:column property="staff" title="Staff"/>
				<display:column property="event_name" title="Event"/>
				<display:column property="st_desc" title="Service Type"/>
				<display:column property="hrs" title="Hours"/>
				<display:column property="date" title="Date"/>	
				<display:column property="status" title="Status"/>
				<display:column property="pm_name" title="PM"/>	
				<display:column property="pa_name" title="PA"/>
			</display:table>
		</td>
	</tr>
</table>
