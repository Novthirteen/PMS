	...
	<td>
		<table border="0" cellpadding="2" cellspacing="2" width="100%">
			...
			<tr align="center" bgcolor="#e9eee9">
				...
				%>
					<td align="left" class="lblbold"><%=AmtStr%><input type=hidden name="AmtRecId" value="<%=RecId%>"></td>
				<%
					}
				}
				%>
			...
			<tr align="center" bgcolor="#e9eee9">
				...
				%>
					<td align="left" class="lblbold"><input name="AmtRecValue" type=text class=inputBox size=8 value="<%=AmtStr%>" <%=fRead%> onblur="checkDeciNumber2(this,1,1,'Amount Value',-9999999,9999999);CalcTot()"></td>
				<%
					}
				}
				%>
