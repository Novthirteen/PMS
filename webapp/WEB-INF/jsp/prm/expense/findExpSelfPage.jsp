...
<%
if (AOFSECURITY.hasEntityPermission("EXPENSE_SELF", "_VIEW", session)) {
...
<form name="frm" action="findExpSelfPage.do" method="post">
<table width=100% cellpadding="1" border="0" cellspacing="1">
<CAPTION align=center class=pgheadsmall>Expense Forms List</CAPTION>
<tr>
	<td>
		<TABLE width="100%">
			<tr>
				<td colspan=9><hr color=red></hr></td>
			</tr>
			<tr>
				<td class="lblbold">Project:</td>
				<td class="lblLight"><input type="text" name="textproj" size="15" value="<%=textproj%>" style="TEXT-ALIGN: right" class="lbllgiht"></td>
				...
				<td class="lblLight">
					...
					<option value="Draft" <%if (textstatus.equals("Draft")) out.print("selected");%>>Draft</option>
			...
			<tr>
				...
				<td  align="right" >
					...
					<input TYPE="button" class="button" name="btnNew" value="New" onclick="location.replace('editExpense.do');">
				</td>
			</tr>
			<tr>
				<td colspan=9 valign="top"><hr color=red></hr></td>
			</tr>
		</Table>
	</td>
</tr>
<tr>
	<td>
		<table border="0" cellpadding="2" cellspacing="2" width=100%>
			<tr bgcolor="#e9eee9">
				<td align="center" class="lblbold" width="1%">#&nbsp;</td>
			...
			<tr bgcolor="#e9eee9">
                <td align="center"><a href="editExpense.do?DataId=<%=em.getId()%>"><%=i++%></a></td>
                ...
                <td align="left">
					<a href="editExpense.do?DataId=<%=em.getId()%>"><%=em.getFormCode()%></a> 
                </td>
				...
				<%if (em.getStatus().equals("Rejected") || em.getStatus().equals("F&A Rejected")){%>
					<td align="center"><font color="Red"><%=em.getStatus()%></font></td>
				<%}else{%>
