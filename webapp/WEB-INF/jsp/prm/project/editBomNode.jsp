...
<%}
	...
	ProjPlanBom bom = (ProjPlanBom)request.getAttribute("selfBom");
...
<input type="hidden" name="bomid" id="bomid" value="<%=bom.getId()%>">
	...
	<td class="lblbold" align="center"><input size="50" type="text" name="add_desc" value="<%if(bom!=null)out.print(bom.getStepdesc());%>"
...
<table>
	...
	<td class="lblbold" align="center"><input type="submit" value="Save" class="button"></td>
	</tr>
