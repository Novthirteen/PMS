...
<form name="frm1" action="findProjBOM.do?formaction=listreve" method="post">
<table width=100% cellpadding="1" border="0" cellspacing="1">
<CAPTION align=center class=pgheadsmall>Project BOM List(Proposal)</CAPTION>
<tr>
  ...
  <TR>
    <TD width='100%'>
          ...
          %>
              	...
              	<td><p align="left"><a href="editProjBOMReve.do?masterid=<%=mst_id%>&formaction=view"><%=bom_link%></a></td>
