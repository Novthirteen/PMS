...
function showCustomerDialog()
{
	...
	with(document.frm)
	{
		...
		if (v != null) {
			document.getElementById("textcust").value = v.split("|")[1];
		}
	}
}
	...
	<TABLE width="100%">
	    ...
	    <tr>
	    	...
	    	<td  align="middle">
			    ...
			    <input type="button" value="New" class="button" onclick="location.replace('editContractProject.do')">
...
<TABLE border=0 width='100%' cellspacing='2' cellpadding='2' class=''>
  ...
  <tr bgcolor="#e9eee9">  
    ...
    <td align="left"> 
    	...
    	%>
		<a href="editContractProject.do?DataId=<bean:write name="p" property="projId"/>"><bean:write name="p" property="projId"/></a> 
		<%
			} else {
		%>
