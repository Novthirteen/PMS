...
<form action="findProjBOM.do?formaction=listsche" method="post" name="frm1">
<table width=100% cellpadding="1" border="0" cellspacing="1">
<CAPTION align=center class=pgheadsmall>Project BOM List(Schedule)</CAPTION>
<tr>
  ...
  <TR>
    <TD width='100%'>
          ...
          %>
              	...
              	<td><p align="left"><a href="editProjBOMSche.do?masterid=<%=mst_id%>&formaction=view"><%=bom_link%></a></td>
