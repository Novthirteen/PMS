...
<form action="findMOProjAccpPage.do" method="post" name="EditForm">
            ...
            if ((c%2) == 1){ %>
             ...
             <% } else {%>
              <tr bgcolor="#EAF3E7"> 
              	<%}%>
           		<td><%=c%></td>
           		<td><a href="editMOProjAccp.do?DataId=<bean:write name="p" property="projId"/>"><bean:write name="p" property="projId"/></a></td>
