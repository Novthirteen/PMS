   ...
   <TR>
    <TD width='100%' colspan="4">
      ...
      <tr>
        ...
        <td>
          <%=Num_formater.format(CustProject.gettotalServiceValue())%>
        </td>
		<td align="right" >
          <span class="tabletext">Total Proc./Sub Value(RMB):&nbsp;</span>
        </td>
        <td>
          <%=Num_formater.format(CustProject.gettotalLicsValue())%>
        </td>
      </tr> 
      <tr>
        <td align="right" >
        ...
        <td>
          <%=Num_formater.format(CustProject.getPSCBudget())%>
        </td>
        <td align="right">
          <span class="tabletext">Expense Budget(RMB):&nbsp;</span>
        </td>
        <td align="left">
          <%=Num_formater.format(CustProject.getEXPBudget())%>
        </td>
      </tr>
	  <tr>
        <td align="right" >
        ...
        <td align="left">
          <%=Num_formater.format(CustProject.getProcBudget())%>
        </td>
		<td align="right" >
