...
if (AOFSECURITY.hasEntityPermission("CUST_BID_PROJECT", "_VIEW", session)) {
...
%>
<form name="" action="listBidProject.do" method="post">
<table>
<tr>
	<td>
		<%
	...
	<td>   
	    <input type="button" value="New" class="" onclick="location.replace('editBidProject.do')">
	</td>
</tr>
</table>
</form>
  ...
  <TR>
    <TD width='100%'>
			...
			<tr>  
                <td align="left"><%=i++%></td>
                <td> 
					<a href="editBidProject.do?DataId=<bean:write name="p" property="projId"/>"><bean:write name="p" property="projId"/></a> 
                </td>
                <td>
                    <div class="tabletext">
                ...
                <td>
                    ...
                    <p > <%=((ProjectMaster) p).getDepartment().getDescription()%> 
					  ...
					  <td width="100%" colspan="8" align="right">
						...
						<a href="listBidProject.do?offset=<%=offset.intValue()-length.intValue()%>"><image src="<%=request.getContextPath()%>/images/pre.gif" border="0"></a>
						<%}%>
						<a href="listBidProject.do?offset=<%=offset.intValue()+length.intValue()%>"><image src="<%=request.getContextPath()%>/images/next.gif"  border="0"></a>                    
						</td>
					  </tr>
                    </table>
                </td>
