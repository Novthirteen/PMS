...
<%
if (AOFSECURITY.hasEntityPermission("CUST_BID_PROJECT", "_CREATE", session)) {
...
<%
    if(CustProject != null){
    	action="Update";
%>
<form action="editBidProject.do" method="post" name="EditForm">
<IFRAME frameBorder=0 id=CalFrame marginHeight=0 
    ...
    <table width='100%' border='0' cellpadding='0' cellspacing='2'>
      ...
      <tr>
		...
		<td></td>
	    <td align="center">
		<input type="button" value="Back To List" class="loginButton" onclick="location.replace('listBidProject.do')">
		</td>
      </tr> 
    </table>
	</td>
