...
%>
<html:form action="/payProjectList.do" method="POST">
...
<table width=100% align=center Frame=box rules=none border=1 bordercolordark=black bordercolorlight=white bgcolor=white>
	...
	<tr class="listbody">
		<td><input type=radio name=chk value="<bean:write property="projId" name="projectList"/>|<bean:write property="projName" name="projectList"/>|<bean:write property="contractType" name="projectList"/>|<bean:write property="department.partyId" name="projectList"/>|<bean:write property="department.description" name="projectList"/>|<bean:write property="vendor.partyId" name="projectList"/>|<bean:write property="vendor.description" name="projectList"/>|<bean:write property="projectManager.userLoginId" name="projectList"/>|<bean:write property="projectManager.name" name="projectList"/>"></td>
	...
	<tr>
		...
		<logic:iterate id="PageNumberList"  name="PageNumberList" >
			...
			<logic:notEqual name="PageNumberList" property="pageLink" value="0">
				<a href="payProjectList.do?pageNumber=<bean:write name="PageNumberList" property="pageLink"/>"><bean:write name="PageNumberList" property="pageNumber" /></a>
			</logic:notEqual>
			&nbsp
		</logic:iterate>
		</td>
