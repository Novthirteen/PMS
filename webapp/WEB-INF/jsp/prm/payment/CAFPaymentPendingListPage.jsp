...
<%
		List ctList = (List)request.getAttribute("CAFTransactionList");
		if (ctList != null && ctList.size() > 0) {
			for (int i0 = 0; i0 < ctList.size(); i0++) {
				PaymentTransactionDetail btd = (PaymentTransactionDetail)ctList.get(i0);
%>
<tr align="center" bgcolor="#e9eee9">
	<TD align="center">
		<%
