  ...
  <td>
	...
	<tr>
	  <td width='100%' height='20'>
	    ...
	    <tr>
	      ...
	      <td align=left class="wpsPortletTopTitle"><bean:message key="helpdesk.attachment.upload.title"/> - <span style="font-weight:normal"><bean:message key="helpdesk.attachment.upload.maxFileSize"/> <span style="color:red;">3000K</span>.</span></td>
	...
	<tr>
	  <td width='100%' height='117' bgcolor='#deebeb'>
		<html:form action="helpdesk.insertAttachment.do" enctype="multipart/form-data" method="post" onsubmit="return validateUploadForm(this)">
		  ...
		  <tr>
			<td nowrap><span class="labeltext"><bean:message key="helpdesk.attachment.upload.titleField"/>:</span></td>
			<td><html:text property="title" size="30" maxlength="255"/></td>
		  </tr>
		  <tr>
