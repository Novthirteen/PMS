	...
	function showCategoryTreeDialog() {
    	with(document.kbForm) {
	    	v = window.showModalDialog(
	    		...
	    		"partyid=" + customer_partyId.options[customer_partyId.selectedIndex].value +
...
<tr>
  ...
  <td>
	...
	<tr>
	  <td height='20'>
	    ...
	    <tr>
	      ...
	      <td align=left class="wpsPortletTopTitle"><bean:message key="helpdesk.kb.edit.title"/></td>
	...
	<tr>
	  <td bgcolor="#deebeb">
	    <html:form action="helpdesk.updateKnowledgeBase.do" method="post" focus="keyword" onsubmit="return validateKbForm(this);">
	    ...
	    <div style='margin:5px'>
	      ...
	      <input type="button" value="<bean:message key="button.cancel"/>" onclick="window.location.href = 'helpdesk.viewKnowledgeBase.do?id=<bean:write name="kbForm" property="id"/>';"/>
	    </div>
	    <table border="0" cellpadding="0" cellspacing="2" width="100%">
	    <tr>
	      <td class="labeltext" width="120"><bean:message key="helpdesk.kb.id.label"/>:</td>
	      <td><bean:write name="kbForm" property="id"/></td>
	    ...
	    <tr>
	      ...
	      <td>
	        <html:select property="customer_partyId">
	          <html:options name="X_customerIDList" labelName="X_customerNameList"/>
	        </html:select>
	      </td>
	    </tr>
	    <tr>
	      ...
	      <td>
	        ...
	        <span id="category_pathdesc"><bean:write name="X_categoryPathDesc"/></span>
