  ...
  <td>
	...
	<tr>
	  <td width='100%' height='20'>
	    ...
	    <tr>
	      ...
	      <td align=left class="wpsPortletTopTitle"><bean:message key="helpdesk.call.requesttype.new.title"/></td>
	...
	<tr>
	  <td width='100%' bgcolor='#deebeb'>
	    <html:form action="helpdesk.insertRequestType.do" method="post" onsubmit="return validateRequestTypeForm(this);">
	    ...
	    <tr>
	      ...
	      <td>&nbsp;<html:select property="callType_type"><html:options collection="X_CallType" property="type" labelProperty="typedesc"/></html:select></td>
	    </tr>
	    <tr>
