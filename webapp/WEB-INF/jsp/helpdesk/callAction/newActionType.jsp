  ...
  <td>
	...
	<tr>
	  <td width='100%' height='20'>
	    ...
	    <tr>
	      ...
	      <td align=left class="wpsPortletTopTitle"><bean:message key="helpdesk.call.actiontype.new.title"/></td>
	...
	<tr>
	  <td width='100%' bgcolor='#deebeb'>
	    <html:form action="helpdesk.insertActionType.do" method="post">
	    ...
	    <tr>
	      ...
	      <td>
	       <html:select property="callType_type">
	    ...
	    <tr>
	      ...
	      <td><html:text property="actiondesc" maxlength="255" size="20"/></td>      
	    </tr>
	    <tr>
	      ...
	      <td>
	       <html:select property="actiondisabled">
	            ...
	            <html:option value="ture" key="helpdesk.call.actiontype.actiontypedisabled.choice.yes"/>    
	       </html:select>
	      </td>
	    </tr>
	    </table>
