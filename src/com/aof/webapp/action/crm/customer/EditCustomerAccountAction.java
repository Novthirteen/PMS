 ...
 *
 */
public class EditCustomerAccountAction extends BaseAction{
	...
	public ActionForward perform(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) {
		...
		try{
			...
			if(action.equals("create") || action.equals("update")){
				String QryStr = "select ca from CustomerAccount as ca where (ca.Description = :Description or ca.Abbreviation =:Abbreviation)";
				if (!DataStr.trim().equals("")) QryStr = QryStr + " and ca.AccountId <> "+DataStr;
