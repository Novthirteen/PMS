 ...
 *
 */
public class ListCustProjectEventAction extends BaseAction{
	public ActionForward perform(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response) {
				// Extract attributes we will need
				Logger log = Logger.getLogger(ListCustProjectEventAction.class.getName());
				...
				try{
					...
					//q.setMaxResults(20);
					//result = q.list();
					Criteria crit = session.createCriteria(ProjectEvent.class);
