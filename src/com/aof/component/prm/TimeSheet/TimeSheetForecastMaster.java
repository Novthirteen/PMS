...
public class TimeSheetForecastMaster implements Serializable
{
	/** identifier field */
	...
	/** full constructor */
	public TimeSheetForecastMaster(
		UserLogin TsmUser,
	...
	public void addDetails(TimeSheetForecastDetail ts)
	{
		ts.setTimeSheetForecastMaster(this);
		this.Details.add(ts);
	}
